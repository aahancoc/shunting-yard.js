...
describe("ShuntingYard", function() {
  ...
  describe("resolves this tokenized array:", function() {
    var positiveTest = {
      '10 + 3': ['10', '3', '+'],
      '10 - 3': ['10', '3', '-'],
      '10.5 - 3.25': ['10.5', '3.25', '-'],
  ...
  it('throws SyntaxError on too many closing parentheses', function() {
    expect(shuntingYard.parse.bind(shuntingYard, '1*(3+4))')).to.throw(SyntaxError);
  });

  it('throws SyntaxError if too many closing parentheses', function() {
    expect(shuntingYard.parse.bind(shuntingYard, '1*((3+4)')).to.throw(SyntaxError);
  });
